        ...
        <div class="flex flex-col gap-8 relative">
            ...
            <form class="grid grid-cols-2 gap-6">
                ...
                @if($selectedMode === 'Online')
                    <x-meeting.form-group id="invitation-link" label="Meeting Invitation Link"
                        ...
                        <input aria-label="meeting-invitation-link"
                               ...
                               wire:model.live.debounce="invitationLink" />
                ...
                @else
                    <x-meeting.form-group id="location" label="Meeting Location" class="col-span-2 md:col-span-2">
                        <input aria-label="meeting-location"
                               ...
                               wire:model.live.debounce="location" />
                        <x-input-error :messages="$errors->get('location')" />
                    </x-meeting.form-group>
                @endif

                <x-meeting.form-group id="meeting-create-description" label="Description"
                                      class="col-span-2 md:col-span-2">
                    <textarea
