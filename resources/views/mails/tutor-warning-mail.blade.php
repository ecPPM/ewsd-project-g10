    ...
    <table class="w-full max-w-sm mx-auto mt-10 bg-white shadow-md rounded-lg overflow-hidden">
        <tr>
            <td class="px-6 py-4">
                ...
                &nbsp;
                <p class="mt-4 text-sm text-gray-700">Dear {{ $body['tutor'] }},<br>{{ $body['student'] }}, the student under your guidance has been inactive over 28 days. Please check on them and provide support.<br> If you need any extra support from us, please let us know as well.</p>
                &nbsp;
